...
`,ae=e=>s.createElement(te,null,e.children),ie=m(c.img).attrs({id:"profile"})`
    place-self: center;
    max-width: 400px;
    max-height: 400px;
    border-radius: 50%;
...
`,ne={hidden:{opacity:0,x:"100%"},visible:{opacity:1,x:"0",transition:{type:"spring",stiffness:120,duration:.8}}},oe=()=>{const{ref:e,controls:t}=G("hidden","visible");return s.createElement(ae,null,s.createElement(ie,{src:"https://firebasestorage.googleapis.com/v0/b/myportfolio2692.appspot.com/o/projects%2Fme.jpg?alt=media&token=89b96c1b-1890-491b-ab6b-c9374cfb72b8",loading:"lazy",alt:"profile",ref:e,variants:ne,initial:"hidden",animate:t}))},re=m.section`
    /* min-height: 100vh; */
    min-width: 100%;
    padding: 0 100px;
    display: flex;
...
`,le="(prefers-reduced-motion: no-preference)",me="undefined"==typeof window,se=()=>!!me||!window.matchMedia(le).matches;const ce=e=>({id:String(z(1e4,99999)),createdAt:Date.now(),color:e,size:z(10,20),style:{top:z(0,100)+"%",left:z(0,100)+"%"}}),de=m.span`
    display: inline-block;
    position: relative;
`,fe=m.span`
    position: absolute;
...
`,ge=e=>{var{color:n="#FFC700",textColor:r,children:l}=e,m=((e,n)=>{var o={};for(var r in e)t.call(e,r)&&n.indexOf(r)<0&&(o[r]=e[r]);if(null!=e&&a)for(var r of a(e))n.indexOf(r)<0&&i.call(e,r)&&(o[r]=e[r]);return o})(e,["color","textColor","children"]);const[c,d]=s.useState((()=>((e,t,a=1)=>{const i=[];void 0===t&&(t=e,e=0);for(let n=e;n<t;n+=a)i.push(n);return i})(3).map((()=>ce(n))))),f=function(){const[e,t]=s.useState(se);return s.useEffect((()=>{const e=window.matchMedia(le),a=e=>{t(!e.matches)};return e.addListener(a),()=>{e.removeListener(a)}}),[]),e}();return((e,t,a)=>{const i=s.useRef(1),n=s.useRef(e);s.useEffect((()=>{n.current=e})),s.useEffect((()=>{if("number"==typeof t&&"number"==typeof a){const e=()=>{const o=z(t,a);i.current=window.setTimeout((()=>{n.current(),e()}),o)};e()}return()=>window.clearTimeout(i.current)}),[t,a]),s.useCallback((function(){window.clearTimeout(i.current)}),[])})((()=>{const e=ce(n),t=Date.now(),a=c.filter((e=>t-e.createdAt<750));a.push(e),d(a)}),f?null:50,f?null:450),s.createElement(de,o({},m),c.map((e=>s.createElement(ue,{key:e.id,color:e.color,size:e.size,style:e.style}))),s.createElement(he,{style:{color:r}},l))},ue=({size:e,color:t,style:a})=>s.createElement(fe,{style:a},s.createElement(pe,{width:e,height:e,viewBox:"0 0 68 68",fill:"none"},s.createElement("path",{d:"M26.5 25.5C19.0043 33.3697 0 34 0 34C0 34 19.1013 35.3684 26.5 43.5C33.234 50.901 34 68 34 68C34 68 36.9884 50.7065 44.5 43.5C51.6431 36.647 68 34 68 34C68 34 51.6947 32.0939 44.5 25.5C36.5605 18.2235 34 0 34 0C34 0 33.6591 17.9837 26.5 25.5Z",fill:t}))),xe=m.div`
    flex: 1;
    height: 100%;
    width: 100%;
    display: grid;
...
`,ve=()=>s.createElement(re,{style:{minHeight:"100vh",overflow:"hidden"}},s.createElement(B,null,s.createElement(S,{text:"About Me",id:200})),s.createElement(xe,null,s.createElement(be,null,s.createElement(O,null,s.createElement(F,null,"Hey Folks👋! I am ",s.createElement(ge,null,"Miten Gajjar"),". A 20years old Software Engineer powered by VS Code and Coffee, also a weeb who loves anime and gaming. I am new to community so I prefer to keep learning, continue challenging myself, and do interesting things. I am passionate about building excellent web and mobile apps that improves the lives of people around me."))),s.createElement(oe,null))),we=m.div`
    flex: 1;
    height: 100%;
    width: 100%;
    ${R};
...
`,ye=m.div`
    ...
    align-items: center;
    justify-content: space-around;
`,$e=m.div.attrs({id:"parallex-wrapper"})`
    position: absolute;
    z-index: 2;
    flex: 1;
    height: 100%;
...
`,Fe=m(Ie)`
    ...
    display: flex;
    justify-content: center;
`,Be=m(c.a).attrs({className:"focusable",rel:"noreferrer"})`
    text-decoration: none;
    ${N}
    padding: 5px 0;
    height: 50px;
...
`,Ae={initial:{top:"75%",transition:{type:"tween",duration:.5,ease:"easeOut"}},animate:{top:0,height:"100%",width:"100%",transition:{type:"tween",duration:.5,ease:"easeOut"}},end:{top:"75%",transition:{type:"tween",duration:.5,ease:"easeOut"}}},Re={initial:{scale:1,transition:{type:"tween",duration:.5,ease:"easeOut"}},animate:{scale:1.4,transition:{type:"tween",duration:.5,ease:"easeOut"}}},Ne={initial:{y:"100%",opacity:0},animate:{y:0,opacity:1,transition:{type:"tween",duration:.7,ease:"easeOut",staggerChildren:.2,when:"beforeChildren"}},initialMob:{y:"00%",opacity:1}},Ye={hidden:{opacity:0,scale:.5},animate:{opacity:1,scale:1,transition:{type:"tween",duration:.7,ease:"easeOut"}}},Ve=()=>s.createElement(re,null,s.createElement(B,null,s.createElement(S,{id:400,text:"Creations"})),s.createElement(Se,null,s.createElement(We,{img:"https://firebasestorage.googleapis.com/v0/b/myportfolio2692.appspot.com/o/projects%2Fb2b.png?alt=media&token=9a386d66-515f-40b9-8b0f-6ddd1a4f6eda",title:"BitsToBytes.in",description:"A simple and minimal website created by me for representing our programming club BitsToBytes at college level.",tech:["ReactJS","Firebase"],links:["https://github.com/Bits-to-Bytes/Bits-to-Bytes-React","https://bitstobytes.in"],key:"1"}),s.createElement(We,{key:"2",img:"https://firebasestorage.googleapis.com/v0/b/myportfolio2692.appspot.com/o/projects%2Fptf2.png?alt=media&token=39947c38-4fbe-469b-9e8d-119300b0bcf1",title:"Portfolio V1.0",description:"A responsive portfolio website built using Flutter web for showcasing my profile and uses Firebase for hosting",tech:["Flutter","Firebase"],links:["https://github.com/GajjarMiten/Flutter-Portfolio"]}),s.createElement(We,{key:"3",img:"https://firebasestorage.googleapis.com/v0/b/myportfolio2692.appspot.com/o/projects%2Fcovbit.png?alt=media&token=76703fea-d491-46a2-8f36-dc820ae36540",title:"CovBit",description:"An all in one application to get updated with COVID-19 news, to do self-assessment, to get notification of nearby people to maintain social distancing and to track the location of COVID-19 positive user.",tech:["Flutter","Firebase","CovidAPI"],links:["https://github.com/GajjarMiten/CovBit"]}),s.createElement(We,{key:"4",img:"https://firebasestorage.googleapis.com/v0/b/myportfolio2692.appspot.com/o/projects%2Ftictactoe.png?alt=media&token=9fdd8825-4d02-484c-9f4f-89f136ccadf1",title:"TicTacToe",description:"A multiplayer TicTacToe game built using with flutter with bloc pattern. It uses Minimax algorithm for making pradiction of next move",tech:["Flutter","Firebase"],links:["https://github.com/GajjarMiten/Flutter-tic-tac-toe"]}))),We=({img:e,title:t,description:a,tech:i,links:n})=>{const o=d(),{ref:r,controls:l}=G("hidden","animate"),m=window.matchMedia(L.mobileL);let c="initial";const f=()=>{c=m.matches?"initialMob":"initial"};return f(),s.useEffect((()=>(window.addEventListener("resize",f),()=>window.removeEventListener("resize",f))),[]),s.createElement(He,{ref:r,variants:Ye,initial:"hidden",animate:l,onMouseEnter:async()=>{o.start("animate")},onMouseLeave:async()=>{o.start("end"),o.start("initial")}},s.createElement(h,null,s.createElement(je,{src:e,loading:"lazy",variants:Re,initial:"initial",animate:o,alt:"project-img"}),s.createElement(De,{key:e,variants:Ae,initial:"initial",animate:o},s.createElement(Oe,null,t),s.createElement(Ge,{variants:Ne,initial:c,animate:o},s.createElement(Te,{variants:Ne},a),s.createElement(Ie,{variants:Ne},i.map(((e,t)=>s.createElement("p",{key:t.toString()},e)))),s.createElement(Fe,{variants:Ne},null==n?void 0:n.map(((e,t)=>0==t?s.createElement(Be,{href:e,target:"_blank",key:"g-link"},s.createElement("img",{src:ze,alt:"github-svg"})):e?s.createElement(Be,{href:e,target:"_blank",key:"web-link"},s.createElement("img",{src:"/assets/link.bbd2f6b0.svg",alt:"link-svg"})):void 0)))))))},_e=m(c.form).attrs({className:"contact-form"})`
    ${R}
    gap: 4rem;
    @media ${L.laptopL} {
        gap: 1rem;
...
`,Ze={initial:{boxShadow:"none"},hover:{boxShadow:"0px 0px 20px 1px #22D1EE",backgroundColor:"rgba(255, 255, 255, 0.1)",transition:{duration:.8,repeat:1/0,repeatType:"reverse"}},tap:{scale:1.2}},Ke={initial:{opacity:0,y:"40%"},animate:{opacity:1,y:0,transition:{type:"spring",duration:.8,stiffness:90}}},Qe=()=>{const{ref:e,controls:t}=G("initial","animate");return s.createElement(_e,{ref:e,variants:Ke,initial:"inital",animate:t,onSubmit:e=>{e.preventDefault()}},s.createElement(Ue,null,s.createElement(Pe,null,s.createElement(qe,{htmlFor:"name"},"I am"),s.createElement(Xe,{id:"name",name:"name",placeholder:"Awesome"})),s.createElement(Pe,null,s.createElement(qe,{htmlFor:"email"},"My Email is"),s.createElement(Xe,{id:"email",name:"email",placeholder:"You@Top.com"}))),s.createElement(Pe,null,s.createElement(qe,{htmlFor:"message"},"Let's Talk on"),s.createElement(Je,{id:"message",name:"message",placeholder:"Something Creative..."})),s.createElement(Pe,null,s.createElement(Xe,{type:"submit",value:"Send 🏹",className:"focusable",variants:Ze,whileFocus:"hover",whileHover:"hover",whileTap:"tap"})))},et=m(c.a)`
    text-decoration: none;
    color: ${({theme:e})=>e.accentColor};
    font-family: ${({theme:e})=>e.fontText};
    font-size: ${({theme:e})=>e.textLG};
...
`,tt=({children:e,link:t})=>s.createElement(et,{href:t,className:"focusable"},e);m.div`
    position: relative;
...
`,ct=m(c.div)`
    ...
    justify-content: center;
    flex-wrap: wrap;
`,dt=m.a.attrs({target:"_blank",rel:"noreferrer"})`
    padding: 10px;
...
`;const pt=()=>s.createElement(re,{style:{minHeight:"100vh",padding:"0"}},s.createElement(B,{marginH:100},s.createElement(S,{id:500,text:"Contact"})),s.createElement(lt,null,s.createElement(Qe,null),s.createElement(gt,null))),ht={initial:{y:100,opacity:0},animate:{y:0,opacity:1,transition:{type:"spring",stiffness:90,staggerChildren:.1,when:"beforeChildren"}}},gt=()=>{const{ref:e,controls:t}=G("initial","animate");return s.createElement(mt,{ref:e,variants:ht,initial:"initial",animate:t},s.createElement(st,{variants:ht},s.createElement(it,null),s.createElement(nt,null),s.createElement(ot,null),s.createElement(rt,null),s.createElement("p",null,"Have any question or want to talk with me ? You can easily connect with me via email at",s.createElement(tt,{link:"mailto:miten3377@gmail.com"},"miten3377@gmail.com"),"or feel free to drop a message in the form!😃")),s.createElement(ct,{variants:ht},s.createElement(dt,{href:"https://codepen.io/Mi10/"},s.createElement("img",{src:"/assets/codepen.6c9311ba.svg",alt:"social-icon"})),s.createElement(dt,{href:"https://github.com/GajjarMiten/"},s.createElement("img",{src:ze,alt:"social-icon"})),s.createElement(dt,{href:"https://www.linkedin.com/in/mitengajjar/"},s.createElement("img",{src:"/assets/linkedin.8de0c099.svg",alt:"social-icon"})),s.createElement(dt,{href:"https://twitter.com/GajjarMiten/"},s.createElement("img",{src:"/assets/twitter.a634ce74.svg",alt:"social-icon"})),s.createElement(dt,{href:"https://www.instagram.com/_.mi10._/"},s.createElement("img",{src:"/assets/instagram.0f0836fe.svg",alt:"social-icon"}))),s.createElement(ft,{variants:ht},"Made With ❤️ By ",s.createElement(ge,null,"Miten Gajjar")))},ut=m(c.div).attrs({id:"cursor"})`
    pointer-events: none;
    z-index: 20;
    position: fixed;
    top: 0;
...
`;setTimeout((()=>{b.render(s.createElement(vt,null),document.getElementById("root"))}),1500);
